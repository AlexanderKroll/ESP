...
def calculate_atom_and_bond_feature_vectors(mol_files):
    ...
    try:
        os.mkdir(join(CURRENT_DIR, ".." ,"data", "substrate_data_KM", "mol_feature_vectors"))
    except FileExistsError:
        None
    
    #existing feature vector files:
    feature_files = os.listdir(join(CURRENT_DIR, ".." ,"data", "substrate_data_KM", "mol_feature_vectors"))
...
def calculate_atom_feature_vector_for_mol_file(mol, mol_file):
    ...
    with open(join(CURRENT_DIR, ".." ,"data", "substrate_data_KM", "mol_feature_vectors", mol_file.replace(":", "_") + "-atoms.txt"), "wb") as fp:   #Pickling
...
def calculate_bond_feature_vector_for_mol_file(mol, mol_file):
    ...
    with open(join(CURRENT_DIR, ".." ,"data", "substrate_data_KM", "mol_feature_vectors", mol_file.replace(":", "_") + "-bonds.txt"), "wb") as fp:   #Pickling
...
try:
    os.mkdir(join(CURRENT_DIR, ".." ,"data", "substrate_data_KM","GNN_input_matrices"))
except FileExistsError:
    None
...
def create_bond_feature_matrix(mol_name, N =70):
    ...
    try:
        with open(join(CURRENT_DIR, ".." ,"data", "substrate_data_KM", "mol_feature_vectors",
...
def calculate_and_save_input_matrixes(molecule_ID, save_folder = join(CURRENT_DIR, ".." ,"data", "substrate_data_KM",
                                                                      "GNN_input_matrices")):
